...
{
    [TestFixture]
    public class ExtraLazyFixture : JetTestBase
    {
        public ExtraLazyFixture()
            : base(true)
        {
        }
        ...
        {
            get { return typeof(JetTestBase).Assembly; }
        }
        ...
        public void ExtraLazyWithWhereClause()
        {
            ...
            {
                s.CreateSQLQuery("insert into Users (Name,PasswordValue) values('gavin','secret')")
                    .UniqueResult();
